  ...
  $.extend({
    jsonRPC: {
      ...
      request: function(method, options) {
        ...
        this._doRequest($.toJSON(this._requestDataObj(method, options.params, options.id)), options);
      ...
      batchRequest: function(requests, options) {
        ...
        this._doRequest($.toJSON(data), options);
      },
...
//          },
      ...
      _requestUrl: function(url) {
        ...
        var l_querystring = url.split("?").slice(1);
